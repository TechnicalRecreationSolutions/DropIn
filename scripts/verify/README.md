...
node --experimental-strip-types scripts/verify/verify-bc.mjs  # the Settings section: nine pages walked as four roles, the moved URLs, the import gate, the delete (111 assertions) — NEEDS 062 APPLIED for sections 3-4
